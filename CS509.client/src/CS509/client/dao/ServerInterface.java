...
public class ServerInterface {
	...
	public String getFlights (String team, String airportCode, String day,boolean isByDeparture) {
	// public Flight getFlights (String team, String airportCode, String day,boolean isByDeparture) {
		...
		try {
			 ...
			 * Create an HTTP connection to the server for a GET 
			 */
			if(isByDeparture)url = new URL(mUrlBase + QueryFactory.getFlightsDeparting(team,airportCode,day));
			else url = new URL(mUrlBase + QueryFactory.getFlightsArriving(team, airportCode, day));
			connection = (HttpURLConnection) url.openConnection();
			connection.setRequestMethod("GET");
			connection.setRequestProperty("User-Agent", team);
